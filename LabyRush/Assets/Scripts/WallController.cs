		...
		for (int Z = 0; Z<9; Z++)
		{
			...
			for(int i = 0; i<9; i++)
			{
				for(int l = 0; l<9; l++)
				{
					...
					if( wallBoolArray[0] == 1 && wallBoolArray[1] == 1 && wallBoolArray[2] == 1 && wallBoolArray[3] == 1)
					{
						int y = Generator.Next(4);
						wallBoolArray[y] = 0;
					}

					if( wallBoolArray[0] == 0 && wallBoolArray[1] == 0 && wallBoolArray[2] == 0 && wallBoolArray[3] == 0)
					{
						int y = Generator.Next(4);
						wallBoolArray[y] = 1;
					}
					...
					if(Z == 5 && i == 8 && l == wallHoleArray[9])
						{
						wallBoolArray[2] =0;
						Debug.Log(wallHoleArray[9] + " " + wallBoolArray[2]);
						}
